...
const Hero = () => {
  return (
    <section className="relative overflow-hidden bg-linear-to-r from-purple-600 via-purple-500 to-indigo-600 dark:from-purple-950/80 dark:via-purple-900/80 dark:to-indigo-950/80">
      <div className="container mx-auto flex flex-col items-center justify-center px-4 py-12 text-center sm:py-20 md:px-6">
        ...
        <p className="mx-auto mt-6 max-w-2xl text-lg text-gray-200 sm:text-xl">
          ...
          Cloudflare. Build production-ready applications in minutes.
        </p>
        ...
        <div className="mt-16 grid grid-cols-2 gap-4 md:grid-cols-3 lg:mt-20">
          <div className="flex flex-col items-center rounded-lg bg-white/10 px-8 py-4 backdrop-blur-xs">
          ...
          <div className="flex flex-col items-center rounded-lg bg-white/10 px-8 py-4 backdrop-blur-xs">
            ...
            <span className="mt-3 font-medium text-white">Easy to Use</span>
          </div>
          <div className="col-span-2 flex flex-col items-center rounded-lg bg-white/10 px-8 py-4 backdrop-blur-xs md:col-span-1">
